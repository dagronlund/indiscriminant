...
#[test]
fn test_bits() {
    #[indiscriminant_bits(u8, 8, Default)]
    pub enum TestEnum {
        A = 0,
        B = 1,
        C = 2,
    ...
    #[indiscriminant_bits(u8, Default = 8)]
    ...
    assert!(TestEnumAuto::Default.to_int() == 8);
    ...
    #[indiscriminant_bits(u16, 8, Default)]
    #[derive(PartialEq)]
    pub enum TestEnum16 {
        A = 0,
        B = 1,
    ...
    #[indiscriminant_bits(u8, 2, Default)]
    #[derive(PartialEq)]
    ...
    #[indiscriminant_bits(u8, 2)]
    #[derive(PartialEq)]
    pub enum TestEnumOption {
        A = 0,
        B = 1,
        D = 3,
    }

    assert!(TestEnumOption::A.to_int() == 0);
    assert!(TestEnumOption::B.to_int() == 1);
    assert!(TestEnumOption::D.to_int() == 3);

    assert!(TestEnumOption::from_int(0) == Some(TestEnumOption::A));
    assert!(TestEnumOption::from_int(1) == Some(TestEnumOption::B));
    assert!(TestEnumOption::from_int(2) == None);
    assert!(TestEnumOption::from_int(3) == Some(TestEnumOption::D));
}

#[test]
fn test_byte_str() {
    #[indiscriminant_byte_str(Default = b"")]
    #[derive(PartialEq)]
...
fn test_str() {
    ...
    #[indiscriminant_str(Default = "Test")]
    #[derive(PartialEq)]
    pub enum TestEnumDefaultOther {
        A = "A",
        B = "B",
    }

    assert!(TestEnumDefaultOther::Default.to_str() == "Test");
...
#[test]
fn test_all() {
    #[indiscriminant(Default = "")]
    #[derive(PartialEq)]
    pub enum TestEnumStr {
        A = "A",
        B = "B",
    }

    #[indiscriminant(Default = b"")]
    #[derive(PartialEq)]
    pub enum TestEnumByteStr {
        A = b"A",
        B = b"B",
    }

    #[indiscriminant(u8, Default = 2)]
    #[derive(PartialEq)]
    pub enum TestEnumBits {
        A = 0,
        B = 1,
    }
}
